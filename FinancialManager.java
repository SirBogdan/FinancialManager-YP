...
public class FinancialManager {
    public static void main(String[] args) {
        ...
        String moneyBeforeSalary1 = scanner.nextLine();
        double moneyBeforeSalary = Double.parseDouble(moneyBeforeSalary1);
        System.out.println("Сколько дней до зарплаты?");
        String daysBeforeSalary1 = scanner.nextLine();
        int daysBeforeSalary = Integer.parseInt(daysBeforeSalary1);
        ...
        while (true) {
            ...
            int command = Integer.parseInt(command1);
            ...
            if (command == 1) {
                ...
                String expense1 = scanner.nextLine();
                double expense = Double.parseDouble(expense1);
